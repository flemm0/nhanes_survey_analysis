...
*Figure 1a) Hourly average sugar consumption grouped by day of the week.* Average sugar consumption is high at around midnight on Sunday and Friday, but low on Monday and Thursday. Then, the lines for each of the days seem to converge at around 10:00 AM, and increase until the end of the day. 

*Figure 1b) Hourly average saturated fatty acid consumption grouped by day of the week.* Average saturated fatty acid consumption is high around midnight on Saturday and Sunday, and lines for all days converge at around 7:00 AM. From there, the average saturated fatty acid consumption increases until the end of the day, especially so for Wednesday, which sees a dramatic spike in average saturated fatty acid consumption after 6:00 PM.
...
fig2.a <- df[, eating_cat := 
    ...
    add_boxplot() %>%
    layout(yaxis = list(title = "Eating Occasion"), xaxis = list(title = ""))
...
*Figure 3a) Proportion of total sugar consumption within each age and gender category by race.*

*Figure 3b) Proportion of total saturated fatty acid consumption within each age and gender category by race.*
...
fig4.a <- df %>%
  ...
  add_boxplot() %>%
  layout(yaxis = list(tickfont = list(size = 8)))
...
subplot(fig4.a, fig4.b, nrows = 2, margin = 0.05) %>%
  layout(annotations = annotations)
```

*Figure 4a) Distribution of sugar consumption (square root transformed) for each source of food.*

*Figure 4b) Distribution of saturated fatty acid consumption (square root transformed) for each source of food.*
